              ...
              <div className="blog-1-block wow fadeInLeft">
                ...
                <div className="blog-1-bottom-content">
                  ...
                  <ul className="d-flex blog-1-meta-info">
                    <li>
                      <i className="icon-12"></i>Admin
                    </li>
                    <li>
                      <i className="icon-13"></i>0 Comnt
                    </li>
                  </ul>
                  ...
                  <div className="blog-1-link-btn">
                    <Link href="/blog-details" className="btn-1 btn-small">
                      Read More <span></span>
                    </Link>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="blog-1-block wow fadeInLeft">
                <div className="blog-1-image">
                  ...
                  <div className="blog-1-date">
                    <span>15</span> <br /> APRIL
                  </div>
                </div>
                <div className="blog-1-bottom-content">
                  <h4 className="blog-1-title">
                    <Link href="/blog-details">
                      Inspire Design Decisions Was With Giovanni Pintorie
                    </Link>
                  </h4>
                  <ul className="d-flex blog-1-meta-info">
                    <li>
