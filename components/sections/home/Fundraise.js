        ...
        <div className="auto-container">
          <div className="section_heading text-center mb_90">
            ...
            <h2 className="section_heading_title_big">
              We’re Take Care of Your Problems <br /> Carefully
            </h2>
          </div>
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div
                className="fundraise-1-block wow fadeInLeft"
                data-wow-delay=".2s"
              ...
              >
                ...
                <div className="fundraise-1-content">
                  ...
                  <p className="fundraise-1-text">
                    Amet minim mollit no duis deserut lamo sit enim aliqua dolor
                    do amet sint Velit officia consequt.
                  </p>
                        ...
                        <div className="progressbar-1-inner progress-line">
                          <div className="progressbar-1-percentage">
                            <div className="count-box">
                              <span className="count-text">85</span>%
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="fundraise-1-content">
                  ...
                  <div className="fundraise-1-skill-item">
                    <div className="fundraise-1-skill-bar">
                      <div className="progressbar-1-outer">
                        <div
                          className="progressbar-1-inner progress-line"
                          data-width="85"
                        >
                          <div className="progressbar-1-percentage">
                            <div className="count-box">
